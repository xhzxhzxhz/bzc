...
var DEFAULT_URL="";
var pdftitle;
if(getval.split("=")[0] == "pdffile"){
	if(getval.indexOf("&") > 0){
		var urlarr = getval.split('&');
		 DEFAULT_URL="/pdf/" + urlarr[0].split("=")[1];
		//'use strict';
		pdftitle = urlarr[1].split("=")[1];
	}else{
		DEFAULT_URL="/pdf/" + getval.split("=")[1];
		pdftitle="标准号";
	}
}else{
	DEFAULT_URL="../pdf/nofile.pdf";
}
'use strict';
   ...
   var PDFViewerApplication = {
    ...
    setTitleUsingUrl: function pdfViewSetTitleUsingUrl(url) {
     ...
     try {
      ...
      var titleTmp = (pdftitle == '' || pdftitle == undefined) ? 
    		  (decodeURIComponent(pdfjsLib.getFilenameFromUrl(url)) || url) : pdftitle;
