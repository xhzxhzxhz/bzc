...
*/        String url = "https://api.rtc.huaweicloud.com:10443/sms/batchSendSms/v1"; //APP接入地址+接口访问URI
        ...
        String sender = "10690549122901595"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "c37c434e47484907a89fa1d1ab448727"; //模板ID
       ...
       // String templateParas = "[\"123456\"]"; //模板变量
        String templateParas = "["+vCode+"]"; //模板变量
...
/*    public static void main(String[] args) throws Exception {
        ...
        //必填,全局号码格式(包含国家码),示例:+8615123456789,多个号码之间用英文逗号分隔
        String receiver = "+8615097115518"; //短信接收人号码
