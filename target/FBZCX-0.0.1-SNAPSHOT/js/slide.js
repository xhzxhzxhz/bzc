(function(window,$){
    $.fn.extend({
        mySlide:function(arr,speed){
            ...
            var html='<span class="back"><img style="display: none" src="img/back.png" alt=""/></span><div class="sl_content">';
            ...
            html+='</ul><span class="prev"><img style="display: none" src="img/prev.png" alt=""/></span>';
            ele.html(html);
